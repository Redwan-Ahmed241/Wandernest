            ...
            <div className={styles.depth3Frame01}>
                        ...
                        <div className={styles.searchDropdown}>
                          {filteredVehicles.map((v, idx) => (
                            <div className={styles.searchResult} key={idx}>
                              <img src={v.image} alt={v.name} className={styles.searchResultImg} />
                              <div>
                                <div className={styles.searchResultName}>{v.name}</div>
                                <div className={styles.searchResultDesc}>{v.description}</div>
                              </div>
                            </div>
                          ))}
                        </div>
              ...
              <div className={styles.vehicleCardsGrid}>
                <div className={styles.vehicleCard}>
                  <img className={styles.vehicleImage} alt="SUV Rentals" src="/Figma_photoes/landA.jpeg" />
                ...
                <div className={styles.vehicleCard}>
                  <img className={styles.vehicleImage} alt="Luxury Cars" src="/Figma_photoes/landB.jpg" />
                  <div className={styles.vehicleCardContent}>
                ...
                <div className={styles.vehicleCard}>
                  <img className={styles.vehicleImage} alt="Economy Options" src="/Figma_photoes/Eco.jpg" />
                  <div className={styles.vehicleCardContent}>
              ...
              <div className={styles.depth4Frame2}>
                <div className={styles.depth5Frame03}>
                  <div className={styles.depth6Frame04}>
                    <img className={styles.depth7Frame04} alt="Customer Support" src="/Figma_photoes/cust.svg" />
                  ...
                  <div className={styles.depth6Frame04}>
                    <img className={styles.depth7Frame04} alt="Flexible Booking" src="/Figma_photoes/booking.svg" />
                    <div className={styles.depth7Frame14}>
                      <div className={styles.depth8Frame05}>
                  ...
                  <div className={styles.depth6Frame04}>
                    <img className={styles.depth7Frame04} alt="Insurance Coverage" src="/Figma_photoes/umb.svg" />
                    <div className={styles.depth7Frame14}>
                      <div className={styles.depth8Frame05}>
