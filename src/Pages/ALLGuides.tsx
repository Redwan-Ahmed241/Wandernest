...
const AllGuides:FunctionComponent = () => {
  ...
  const guides = [
    ...
    },
    {
      ...
      fare: '$60/hour',
      timing: '8 AM - 4 PM',
      image: '/Figma_photoes/aboutUsHero.jpg',
    },
  ];
        ...
        <div className={styles.localGuideParent}>
          <div className={styles.depth2Frame1}>
            ...
            <div className={styles.depth8Frame01}>
              <img className={styles.depth9Frame0} alt="search" src="/Figma_photoes/search.svg" />
          ...
          <div className={styles.depth4Frame2}>
            {filteredGuides.map((g, idx) => (
              <div className={styles.depth5Frame03} key={idx} onClick={onDepth4FrameClick}>
                <img className={styles.depth6Frame03} alt={g.title} src={g.image} />
